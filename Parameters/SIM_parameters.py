...
training_group = parser.add_argument_group('SIM_training')
...
training_group.add_argument('--conf_coef', type=float, default=0.0)
...
training_group.add_argument('--min_good',type=float,default=None)
...
training_group.add_argument('--wandb_log',type=str,default='False')
training_group.add_argument('--mode', type=str, default='SIMKC')
