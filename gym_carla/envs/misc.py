...
def rescale_action(action, original_range, new_range):
  original_min, original_max = original_range
  new_min, new_max = new_range

  # Convert action from the original range to a value between 0 and 1
  normalized_action = (action - original_min) / (original_max - original_min)

  # Convert the normalized action to the new range
  scaled_action = normalized_action * (new_max - new_min) + new_min
